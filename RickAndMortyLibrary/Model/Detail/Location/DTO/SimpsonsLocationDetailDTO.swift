...
struct SimpsonsLocationDetailDTO: Codable, Identifiable, Hashable {
    ...
    let town: String?
    let use: String?
    let firstAppearanceSh: SimpsonsFirstAppearanceLocationDTO?
    let firstAppearanceEp: SimpsonsFirstAppearanceLocationDTO?
...
struct SimpsonsFirstAppearanceLocationDTO: Codable, Identifiable, Hashable {
    let id: UUID = UUID()
